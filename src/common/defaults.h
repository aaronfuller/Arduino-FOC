...
#define DEF_PID_CURR_LIMIT (DEF_POWER_SUPPLY) //!< default PID controller voltage limit
#define DEF_CURR_FILTER_Tf 0.001f //!< default currnet filter time constant
#endif
...
#define DEF_MOTION_DOWNSMAPLE 250 //!< default motion downsample - disable
...
#define DEF_VEL_FILTER_Tf 0.5f //!< default velocity filter time constant
